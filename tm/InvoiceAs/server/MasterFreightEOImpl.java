...
// ---------------------------------------------------------------------
public class MasterFreightEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxgam.oracle.apps.xbol.tm.InvoiceAs.server.MasterFreightEO");
        }
     ...
     */
    public static Key createPrimaryKey(String idFreightChar) {
        return new Key(new Object[]{idFreightChar});
    }
}
