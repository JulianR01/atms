...
// ---------------------------------------------------------------------
public class MasterFreightVORowImpl extends OAViewRowImpl {
    public static final int IDFREIGHTCHAR = 0;
    public static final int MODEDESC = 1;
    public static final int IDFOLIO = 2;
    public static final int IDSTRETCH = 3;
    public static final int INVOICESTATUS = 4;
    public static final int ARRIVALDATE = 5;
    public static final int ARRIVALTIME = 6;
    public static final int ATTRIBUTE1 = 7;
    public static final int ATTRIBUTE10 = 8;
    ...
    public static final int AWBBOL = 17;
    public static final int CLASSIFICATION = 18;
    public static final int CREATEDBY = 19;
    public static final int CREATIONDATE = 20;
    public static final int DESTINATION = 21;
    public static final int DISTRIBUTION = 22;
    public static final int DISTRIBUTIONCODE = 23;
    public static final int DOCUMENT1 = 24;
    public static final int DOCUMENT2 = 25;
    public static final int DOCUMENT3 = 26;
    public static final int DOCUMENT4 = 27;
    public static final int ETA = 28;
    public static final int ETAHOUR = 29;
    public static final int ETD = 30;
    public static final int ETDHOUR = 31;
    public static final int FLIGHT = 32;
    public static final int FREIGHTJOB = 33;
    public static final int IDCLASSIFICATION = 34;
    public static final int IDDESTINATION = 35;
    public static final int IDDISTRIBUTION = 36;
    public static final int IDFREIGHT = 37;
    public static final int IDMEDIA = 38;
    public static final int IDMODE = 39;
    public static final int IDORIGIN = 40;
    public static final int IDPROVIDER = 41;
    public static final int IDREQUEST = 42;
    public static final int IDSTATUS = 43;
    public static final int IDZONE = 44;
    public static final int LASTUPDATEDBY = 45;
    public static final int LASTUPDATEDATE = 46;
    public static final int LASTUPDATELOGIN = 47;
    public static final int MEDIA = 48;
    public static final int MODECODE = 49;
    public static final int MULTIPLEDELIVERIESFLAG = 50;
    public static final int NUMDELIVERIES = 51;
    public static final int ORIGIN = 52;
    public static final int PEDIMENT = 53;
    public static final int PRIORITY = 54;
    public static final int PRIORITYCODE = 55;
    public static final int PROVIDER = 56;
    public static final int STATUS = 57;
    public static final int USERATE = 58;
    public static final int ZONEDESC = 59;
    public static final int DETAILFLAG = 60;
    public static final int CHECKBOX = 61;
    public static final int FLAGCON = 62;
    public static final int EXTRACOSTVO = 63;
    public static final int COSTVO = 64;

    /**This is the default constructor (do not remove)
     */
    public MasterFreightVORowImpl() {
    }

    /**Gets MasterFreightEO entity object.
     */
    public MasterFreightEOImpl getMasterFreightEO() {
        return (MasterFreightEOImpl)getEntity(0);
    }
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case DETAILFLAG:
            ...
            return;
        case CHECKBOX:
            setCheckBox((String)value);
            return;
        case FLAGCON:
            setflagCon((Boolean)value);
            return;
        default:
    ...
    /**Gets the associated <code>RowIterator</code> using master-detail link ExtraCostVO
     */
    public RowIterator getExtraCostVO() {
        return (RowIterator)getAttributeInternal(EXTRACOSTVO);
    }
    ...
    /**Gets the attribute value for the calculated attribute flagCon
     */
    public Boolean getflagCon() {
        return (Boolean) getAttributeInternal(FLAGCON);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute flagCon
     */
    public void setflagCon(Boolean value) {
        setAttributeInternal(FLAGCON, value);
    }

    /**Gets the associated <code>RowIterator</code> using master-detail link CostVO
     */
    public RowIterator getCostVO() {
        return (RowIterator)getAttributeInternal(COSTVO);
    }
}
