...
// ---------------------------------------------------------------------
public class ShippersEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxgam.oracle.apps.xbol.tm.catalogue.schema.server.ShippersEO");
        }
    ...
    /**Gets the attribute value for ShipperId, using the alias name ShipperId
     */
    public Number getShipperId() {
        return (Number)getAttributeInternal(SHIPPERID);
    }

    /**Sets <code>value</code> as the attribute value for ShipperId
     */
