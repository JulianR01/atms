...
// ---------------------------------------------------------------------
public class MaterialMEOImpl extends OAEntityImpl
{
  public static final int IDREQUEST = 0;
  public static final int IDMATERIAL = 1;
  public static final int IDMATERIALTYPE = 2;
  public static final int MATERIALTYPE = 3;
  public static final int MATERIALDATE = 4;
  public static final int MATERIALTIME = 5;
  public static final int DISTRIBUTION = 6;
  public static final int IDLOADTYPE = 7;
  public static final int LOADTYPE = 8;
  public static final int IDDGR = 9;
  public static final int DGR = 10;
  public static final int IDDOCUMENT = 11;
  public static final int DOCUMENTDESCRIPTION = 12;
  public static final int NREFERENCE = 13;
  public static final int SHIPMENT = 14;
  ...
  public static final int TOTALWEIGHT = 30;
  public static final int TOTALVOL = 31;
  public static final int HEIGHT = 32;
  public static final int HEIGHTUNITS = 33;
  public static final int IDLOADPRESENTATION = 34;
  public static final int LENGHT = 35;
  public static final int LENGHTUNITS = 36;
  public static final int LOADPRESENTATION = 37;
  public static final int TOTALWEIGHTUNITS = 38;
  public static final int UNITSNUMBER = 39;
  public static final int UNITSTYPE = 40;
  public static final int WEIGHT = 41;
  public static final int WEIGHTUNITS = 42;
  public static final int WIDTH = 43;
  public static final int WIDTHUNITS = 44;
  public static final int MATERIALDEO = 45;
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = 
          (OAEntityDefImpl)EntityDefImpl.findDefObject("xxgam.oracle.apps.xbol.tm.freight.schema.MaterialMEO");
    }
  ...
  /**Gets the associated entity MaterialDEOImpl
   */
  public MaterialDEOImpl getMaterialDEO()
  {
    return (MaterialDEOImpl)getAttributeInternal(MATERIALDEO);
  }

  /**Sets <code>value</code> as the associated entity MaterialDEOImpl
   */
  public void setMaterialDEO(MaterialDEOImpl value)
  {
    setAttributeInternal(MATERIALDEO, value);
  }
